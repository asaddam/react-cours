      ...
      <Form method="POST">
        ...
        <div className="relative mb-5 flex flex-col gap-2 sm:flex-row sm:items-center">
          ...
          {!position.latitude && !position.longitude && (
            <span className="absolute right-[3px] top-[3px] z-50 sm:right-[5px] sm:top-[3px]">
              <Button
                disabled={isLoadingAddress}
                type="small"
                onClick={(e) => {
        ...
        <div className="mb-12 flex items-center gap-5">
          ...
          />
          <label htmlFor="priority" className="text-medium">
            Want to you give order priority?
          </label>
        </div>
...
export async function action({ request }) {
  ...
  // if everithyng is okay, create new order and redirect
